import { Controller, Get, Query, HttpCode, HttpStatus, Version, UseFilters, UsePipes, ValidationPipe, Post, Body } from '@nestjs/common';
...
export class CheckoutController {
    ...
    async fetchOrderSummary(@Query('checkoutToken') checkoutToken: string): Promise<any[]> {
    ...
    async createCheckoutAddress(@Body() payload: CheckoutAddressDTO): Promise<any[]> {
